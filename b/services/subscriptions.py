                ...
                try:
                    ...
                    await bot.send_message(
                        ...
                        text=(
                            ...
                            f"👤 Пользователь {ref_username} зашёл по вашей пригласительной ссылке.\n"
                            f"Мы подарим вам +3 дня, когда он продлит подписку\n\n"
                            "Спасибо, что помогаете проекту расти ❤️"
                        )
                    )
                except Exception:
                    pass
