    ...
    async def send_subscription_activated(
        ...
        try:
            ...
            message_text = (
                ...
                f"🔐 <b>Тариф:</b> <b>{plan_title}</b>\n"
                f"📅 <b>Действует до:</b> <code>{expires_str} МСК</code>\n\n"

                "💌 <b>Подарочные сертификаты</b>\n"
                "Хотите сделать необычный подарок? У нас есть стильные электронные сертификаты на подписку — "
                "идеальный вариант для близких и друзей.\n\n"

                "👫 <b>Приглашайте друзей и получайте бонусы</b>\n"
                "• <b>Вам</b> — <b>+5 дней</b> к подписке за каждого друга с оплаченной подпиской\n"
                "• <b>Друзьям</b> — <b>3 дня</b> бесплатного доступа при первом подключении\n\n"

                "Если появятся вопросы — смело пишите в поддержку, мы всегда рядом. 💬\n\n"
