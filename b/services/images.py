...
class ImageService:
    ...
    async def celebrity_selfie(self, image_bytes: bytes, celebrity_name: str, style: str | None = None) -> tuple[bytes | None, str | None]:
        # SafetyGate: блокируем deepfake со знаменитостями (можно ослабить или сменить провайдера)
