...
async def panel_mode(cq: CallbackQuery):
    ...
    text = (
        ...
        "🏯 <b>Ghibli</b>\n"
        "Преобразование фото в мягкий мультяшный стиль студии Ghibli.\n\n"

        "🚀 <b>Pixar 3D</b>\n"
        "Создание 3D-мультяшного персонажа и окружения в стиле Pixar.\n\n"

        "💥 <b>Комикс</b>\n"
        "Яркая комикс-стилизация с контурами и полутоновыми точками.\n\n"

        "🌸 <b>Аниме</b>\n"
        "Чистый японский аниме-портрет с яркими цветами и линиями.\n\n"

        "📖 <b>Акварель</b>\n"
        "Художественная акварельная стилизация в стиле книги-рассказа.\n"
    )
...
async def send_after_photo_info(m: TgMessage, user_id: int, mode: str):
    ...
    INSTR = {
        ...
        "comic": "💥 Комикс — отправьте фото, я превращу фото в комикс-арт.",
        "anime": "🌸 Аниме — отправьте фото, я превращу фото в аниме.",
        "watercolor": "📖 Акварель — мягкая художественная стилизация. Отправьте фото",
